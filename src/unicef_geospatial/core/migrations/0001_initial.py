# Generated by Django 2.2b1 on 2019-03-14 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processors', to='core.Upload')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('geo_field', models.CharField(max_length=255)),
                ('shape_field', models.CharField(blank=True, max_length=255, null=True)),
                ('mandatory', models.BooleanField(default=True)),
